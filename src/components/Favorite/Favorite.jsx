...
=======
    return (
        <div >
            ...
            <div style={{backgroundImage:'url("/images/563231_l-1.jpg")' , backgroundSize: 'cover', backgroundPosition: 'center',paddingLeft: '230px', paddingTop: '120px', paddingBottom: '180px', display: "flex" }}>
